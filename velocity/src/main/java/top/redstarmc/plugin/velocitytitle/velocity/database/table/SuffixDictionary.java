...
public enum SuffixDictionary implements SQLTable {
    SUFFIX_DICTIONARY((table) -> {
    ...
    private static final String tableName = "SUFFIX_DICTIONARY";

    SuffixDictionary(Consumer<TableCreateBuilder> builder) {
    ...
    public static void initialize(SQLManager sqlManager) throws SQLException {
        SUFFIX_DICTIONARY.create(sqlManager);
    }
}
